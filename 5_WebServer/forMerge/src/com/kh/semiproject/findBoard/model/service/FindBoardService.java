...
public class FindBoardService {
	 ...
	 * @throws Exception
	 */
	public static int insertFindBoard(BoardHJ board, FindBoard findBoard, Animal animal, ArrayList<Attachment> fList) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static int updateFindBoard(BoardHJ board, FindBoard findBoard, Animal animal, ArrayList<Attachment> fList) throws Exception {
		Connection conn = getConnection();
