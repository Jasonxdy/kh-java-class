 ...
 * Generated at: 2020-01-30 08:51:26 UTC
...
public final class management_005fQnA_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.kh.semiproject.qaBoard.model.vo.QnABoard");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	List<QnABoard> qaBoardList = (List<QnABoard>) request.getAttribute("qaBoardList");
      ...
      out.write("<title>미씽펫 - 관리자 QnA 페이지</title>\n");
      out.write("\n");
      ...
      out.print( request.getContextPath() );
      out.write("/daumeditor/css/editor.css\" type=\"text/css\" charset=\"utf-8\"/>\n");
      out.write("<script src=\"");
      out.print( request.getContextPath() );
      out.write("/daumeditor/js/editor_loader.js\" type=\"text/javascript\" charset=\"utf-8\"></script>\n");
      out.write("<style>\n");
      out.write("\n");
 ...
 if(loginMember != null && loginMember.getMemberId().equals("admin")){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\thref=\"");
      out.print(request.getContextPath());
      out.write("/Management/management_Report\">신고\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t관리</a></th>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\n");
      out.write("\t\t\t\t\t\t\t</table>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<th scope=\"col\"><!-- 관리 모달 버튼 --></th>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t</thead>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<tbody>\n");
 ...
 if (qaBoardList.isEmpty()) { 
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td colspan=\"5\">존재하는 QnA게시글이 없습니다.</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t");
 } else { 
      out.write("\n");
 ...
 for (int i = 0; i < qaBoardList.size(); i++) { 
      ...
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>");
      out.print( qaBoardList.get(i).getQaNo() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><span class=\"ContentLength\">");
      out.print( qaBoardList.get(i).getQaTitle() );
      out.write("</span></td>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><span class=\"ContentLength\">");
      out.print( qaBoardList.get(i).getQaContent() );
      out.write(" </span></td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>");
      out.print( qaBoardList.get(i).getQaModifyDt() );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<!-- QnA 수정 모달 -->\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a id=\"modal-120930-");
      out.print( i );
      out.write("\" href=\"#modal-container-120930-");
      out.print( i );
      out.write("\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\trole=\"button\" class=\"btn btn-sm btn-outline-secondary\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tdata-toggle=\"modal\">수정</a> \n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-content\" id=\"modal-renew\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-header\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"modal-title\" id=\"myModalLabel\">QnA 수정</h5>\n");
      ...
      out.print( request.getContextPath() );
      out.write("/Management/updateQnA\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t현재 선택한 글 번호는 <input name=\"UpdateQnANo\" style=\"width:4%\" value=\"");
      out.print( qaBoardList.get(i).getQaNo() );
      out.write("\" readonly> 번 입니다.<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"UpdateQnATitle\" style=\"width:100%\" value=\"");
      out.print( qaBoardList.get(i).getQaTitle() );
      out.write("\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <textArea name=\"UpdateQnAContent\" cols=\"106\" rows=\"20\" style=\"resize:none\">");
      out.print( qaBoardList.get(i).getQaContent() );
      out.write("</textArea>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-header\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"modal-title\" id=\"myModalLabel\">QnA 글 삭제</h5>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span aria-hidden=\"true\">×</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-body\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form class=\"form-signin\" method=\"POST\" action=\"deleteQnA\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div style=\"width:100; overflow:hidden text-overflow:ellipsis\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t현재 선택한 글 번호는 <input name=\"DeleteQnANo\" style=\"width:5%\" value=\"");
      out.print( qaBoardList.get(i).getQaNo() );
      out.write("\" readonly> 번 입니다.<br>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"DeleteQnATitle\" style=\"width:100%\" value=\"");
      out.print( qaBoardList.get(i).getQaTitle() );
      out.write("\" readonly>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <textArea name=\"DeleteQnAContent\" cols=\"63\" rows=\"20\" style=\"resize:none \" readonly>");
      out.print( qaBoardList.get(i).getQaContent() );
      out.write("</textArea>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t<!-- 검색창-->\n");
      out.write("\t\t\t\t\t\t\t<div id=\"searchTab\" style=\"display:inline-block\">\n");
      out.write("\t\t\t\t\t\t\t<div style=\"display:inline-block\" class=\"pl-5\">\n");
      out.write("\t\t\t\t\t\t\t\t<form class=\"col mb-5\" method=\"POST\" action=\"searchQnA\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"SearchQnATitle\" selected>제목</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"SearchQnAContent\">내용</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"SearchQnAModifyDt\">등록일</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-6\" style=\"width: 950px;\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- 글 등록  -->\n");
      out.write("\t\t\t\t\t\t\t\t\t<div style=\"display:inline-block\" style=\"width: 100px;\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<a id=\"modal-QnAwrite\" href=\"#modal-container-QnAwrite\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\trole=\"button\" class=\"btn btn-sm btn-outline-secondary\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tdata-toggle=\"modal\">글 등록</a>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal fade\" id=\"modal-container-QnAwrite\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\trole=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-dialog\" role=\"document\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-content\" id=\"modal-renew\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-header\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"modal-title\" id=\"myModalLabel\">QnA 등록</h5>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"modal\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span aria-hidden=\"true\">×</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form method=\"POST\" action=\"");
      out.print( request.getContextPath() );
      out.write("/Management/insertQnA\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <input type=\"text\" name=\"QnATitle\" placeholder=\"제목 입력\" style=\"width:100%\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t <textArea name=\"QnAContent\" cols=\"106\" rows=\"20\" style=\"resize:none\">등록할 내용을 작성해주세요.</textArea>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-footer\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-outline-primary\" type=\"submit\">등록</button>\n");
