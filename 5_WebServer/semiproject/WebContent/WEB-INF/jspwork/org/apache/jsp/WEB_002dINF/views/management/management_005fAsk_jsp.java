 ...
 * Generated at: 2020-01-31 08:31:44 UTC
...
public final class management_005fAsk_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.kh.semiproject.AskBoard.model.vo.AskBoard");
    _jspx_imports_classes.add("com.kh.semiproject.member.model.vo.Member");
    _jspx_imports_classes.add("com.kh.semiproject.AskBoard.model.vo.Answer");
  }
 ...
 if(loginMember != null && loginMember.getMemberId().equals("admin")){ 
      ...
      out.write("                                <th scope=\"col\">&nbsp;&nbsp;문의자</th>\n");
      out.write("                                  <th scope=\"col\">&nbsp;&nbsp;제목</th>\n");
      out.write("                                  <th scope=\"col\">&nbsp;내용</th>\n");
      out.write("                                  <th scope=\"col\">&nbsp;&nbsp;등록일</th>\n");
      out.write("                                  <th scope=\"col\">답장 여부</th>\n");
      out.write("                                  <th scope=\"col\"> <!--  답장 창 --> </th>\n");
      out.write("                                </tr>\n");
      out.write("                              </thead>\n");
      out.write("                              \n");
      out.write("                              <tbody>\n");
 ...
 if (AskBoardList.isEmpty()) { 
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td colspan=\"5\">존재하는 1:1 문의글이 없습니다.</td>\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t");
 } else { 
      out.write("\n");
 ...
 for (int i = 0; i < AskBoardList.size(); i++) { 
      ...
      out.write("                              \t<tr>\n");
      out.write("                              \t\t<td>");
      out.print( AskBoardList.get(i).getAskNo() );
      out.write("</td>\t\n");
      out.write("                              \t\t<td>");
      out.print( AskBoardList.get(i).getMemberId() );
      out.write("</td>\n");
      out.write("\t                              \t<td>\n");
      out.write("\t\t                              \t<span class=\"ContentLength\">\n");
      out.write("\t\t                              \t\t");
      out.print( AskBoardList.get(i).getAskTitle() );
      out.write("\n");
      out.write("\t\t                              \t</span>\t\n");
      out.write("\t                              \t</td>\t\n");
      out.write("\t                              \t<td>\n");
      out.write("\t\t                              \t<span class=\"ContentLength\">\n");
      out.write("\t\t                              \t\t");
      out.print( AskBoardList.get(i).getAskContent() );
      out.write("\n");
      out.write("\t\t                              \t</span>\t\n");
      out.write("\t                              \t</td>\n");
      out.write("\t                              \t<td>");
      out.print( AskBoardList.get(i).getAskModifyDt() );
      out.write("</td>\t\n");
      out.write("\t                              \t<td>");
      out.print( AskBoardList.get(i).getAskStatus() );
      out.write("</td>\t\n");
      out.write("\t                              \t<td> <!-- 1:1 문의 답장 모달   -->\n");
      out.write("\t                              \t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tclass=\"btn btn-sm btn-outline-secondary reply\" data-toggle=\"modal\">답장</a>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t \n");
      ...
      out.write("                                              <h5 class=\"modal-title\" id=\"myModalLabel\">1:1 문의 답변창</h5>\n");
      out.write("                                              <button type=\"button\" class=\"close\" data-dismiss=\"modal\">\n");
      out.write("                                                <span aria-hidden=\"true\">×</span>\n");
      out.write("                                              </button>\n");
      out.write("                                            </div>\n");
      out.write("                                           <div class=\"modal-body\" >\n");
      out.write("                                                <!-- 사용자가 남긴 질문 -->\n");
      out.write("                                                <div id=\"recievedQuestion\">\n");
      out.write("                                                  \n");
      out.write("                                                    <div>\n");
      out.write("                                                    \t<input type=\"text\" style=\"width:100%\" name=\"recievedAskMemberId\" value=\"");
      out.print( AskBoardList.get(i).getMemberId() );
      out.write("님의 문의입니다.\" >\n");
      out.write("                                                    \t<input type=\"text\" style=\"width:100%\" name=\"recievedAskTitle\" value=\"제목 | ");
      out.print( AskBoardList.get(i).getAskTitle() );
      out.write("\">\n");
      out.write("                                                    </div>\n");
      out.write("                                                    <div>\n");
      out.write("              \n");
      out.write("                                                      \t<textArea name=\"recievedAskContent\" cols=\"97\" rows=\"10\" style=\"resize:none\">내용 |\n");
      out.print( AskBoardList.get(i).getAskContent() );
      out.write("</textArea>\n");
      out.write("                                                \t</div>\n");
      out.write("                                                </div>\n");
      out.write("                                             <form class=\"form-signin\" method=\"POST\" action=\"answer\" >\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" style=\"width:5%\" name=\"answerAskNo\" value=\"");
      out.print( AskBoardList.get(i).getAskNo() );
      out.write("\">번 문의글 답변입니다.\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\n");
      out.write("                                                   <textArea name=\"answerContent\" cols=\"97\" rows=\"10\" style=\"resize:none\">");
      out.print( answerContent );
      out.write("</textArea>\n");
      out.write("                                                </div>\n");
      out.write("                                             \n");
      out.write("                                                \n");
      ...
      out.write("\t\t\t\t\t\t\t\t<form class=\"col mb-5\" method=\"POST\" action=\"searchAsk\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"SearchAskTitle\" selected>제목</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"SearchAskContent\">내용</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\n");
      ...
      out.write("                  \t\t\n");
      out.write("                  \t\tvar askNo = $(this).parent().parent().children().eq(0).text();\n");
      out.write("                  \t\tconsole.log(askNo);\n");
      out.write("                  \t\t\n");
      out.write("                  \t\t\n");
      out.write("                  \t\t$.ajax({\n");
      out.write("                  \t\t\t\n");
      out.write("                  \t\t\turl: \"management_Ask\",\n");
