		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<div class="bg-white rounded shadow-sm container p-3">
					<form method="POST" action="updateMember" onsubmit="return validate();" class="form-horizontal" role="form">
						<!-- 아이디 -->
						...
						<div class="row mb-3 form-row">
							...
							<div class="col-md-6">
								<input type="email" class="form-control" id="email" name="memberEmail" value="${member.memberEmail}">
							</div>
						</div>
						<br>
